"""
Sixpack_Rips Ablation Study — 2^6 = 64 barcode subsets
...
DISPLAY  = [ALIAS.get(k, k) for k in ALL_KEYS]  # image kernel cokernel domain codomain relative
...
# ── CSV 저장 ──────────────────────────────────────────────────────────────────
import csv
out_csv = os.path.join(BASE, "Final_Results(0521)", "sixpack_rips_ablation.csv")
